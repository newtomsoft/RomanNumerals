...
{
    public class ToRomanNumeralsShould
    {
        [Theory]
        [InlineData(1,"I")]
        [InlineData(2,"II")]
        ...
        public void ReturnExpectedWhenNumber(int number, string expected)
        {
            Assert.Equal(expected, RomanNumerals.ToRomanNumerals(number));
        }

        [Fact]
        public void ReturnExceptionWhen4000()
        {
